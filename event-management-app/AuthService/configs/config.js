...
export const config = {
    ...
    email: {
        ...
        user: process.env.SMTP_USER || 'bibliotecain6bm@gmail.com',
        pass: process.env.SMTP_PASS,
        fromEmail: process.env.EMAIL_FROM || 'bibliotecain6bm@gmail.com',
        fromName: process.env.EMAIL_FROM_NAME || 'AuthService',
    },
